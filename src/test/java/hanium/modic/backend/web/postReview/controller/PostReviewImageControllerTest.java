...
class PostReviewImageControllerTest extends BaseControllerTest {
	...
	void createImageSaveUrl_InvalidRequest_ShouldReturn400(CreateImageSaveUrlRequest request, String expectedMessage) throws Exception {
	...
	static Stream<Arguments> invalidCreateImageSaveUrlRequests() {
		return Stream.of(
			...
			Arguments.of(new CreateImageSaveUrlRequest(ImagePrefix.POST_REVIEW, null), "파일 이름은 필수입니다.", "fileName null"),
	...
	void callbackImageSaveUrl_InvalidRequest_ShouldReturn400(CallbackImageSaveUrlRequest request, String expectedMessage) throws Exception {
	...
	static Stream<Arguments> invalidCallbackImageSaveUrlRequests() {
		return Stream.of(
			Arguments.of(new CallbackImageSaveUrlRequest(null, "path/to/file.png", ImagePrefix.POST_REVIEW), "파일명은 필수입니다.", "fileName null"),
			Arguments.of(new CallbackImageSaveUrlRequest("", "path/to/file.png", ImagePrefix.POST_REVIEW), "파일명은 필수입니다.", "fileName 공백"),
			Arguments.of(new CallbackImageSaveUrlRequest("file.png", null, ImagePrefix.POST_REVIEW), "이미지 Path는 필수입니다.", "imagePath null"),
			Arguments.of(new CallbackImageSaveUrlRequest("file.png", "", ImagePrefix.POST_REVIEW), "이미지 Path는 필수입니다.", "imagePath 공백"),
			Arguments.of(new CallbackImageSaveUrlRequest("file.png", "path/to/file.png", null), "이미지 사용 목적은 필수입니다.", "imageUsagePurpose null")
		);
	}
}
