...
public class AiImageGenerationService {
	...
	/**
	 * Returns a URL for accessing the created AI image associated with the given request ID, after verifying user ownership.
	 *
	 * @param requestId the unique identifier of the AI image generation request
	 * @param userId the ID of the user requesting access
	 * @return the URL to access the created AI image
	 * @throws AppException if the user does not own the request or if the created AI image is not found
	 */
	...
	/**
	 * Retrieves a paginated list of AI images generated by the specified user.
	 *
	 * Returns a page of responses containing information about each AI image request with status DONE,
	 * including the generated image URL and associated post ID. Throws an exception if a completed AI request
	 * lacks a corresponding generated image, indicating data inconsistency.
	 *
	 * @param userId the ID of the user whose generated images are to be retrieved
	 * @param page the page number to retrieve (zero-based)
	 * @param size the number of items per page
	 * @return a paginated response containing the user's generated AI images
	 * @throws AppException if a completed AI request does not have a corresponding generated image
	 */
	...
	/**
	 * Validates that the user has permission to generate AI images for the specified post.
	 *
	 * @param userId the ID of the user requesting image generation
	 * @param postId the ID of the post for which image generation is requested
	 * @throws AppException if the user does not have permission for the specified post
	 */
