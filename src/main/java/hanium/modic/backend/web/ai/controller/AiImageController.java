...
public class AiImageController {
	...
	/**
	 * Retrieves the current status of an AI image generation request for the authenticated user.
	 *
	 * @param requestId the unique identifier of the AI image generation request
	 * @param userEntity the currently authenticated user
	 * @return the status of the specified AI image generation request
	 */
	...
	/**
	 * Retrieves a paginated list of AI images generated by the current user, sorted by newest first.
	 *
	 * @param page the page number to retrieve, starting from 0
	 * @param size the number of items per page (between 10 and 20 inclusive)
	 * @return a paginated response containing the user's generated AI images
	 */
